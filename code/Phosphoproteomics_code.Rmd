...
RequiredPackages <- c("BiocManager", "dplyr", "igraph") #yet empty
...
Proteins_connected_to_Stat5b <- string_db$add_proteins_description(gh) #Add´s protein information to STRINGid´s this final file points back to itself (Stat5b)
old_end <- Sys.time()
old_end-old_start
